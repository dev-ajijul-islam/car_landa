class Urls {
  ...
  static String baseUrl = "https://carlanda-server.vercel.app";
  ...
  static String getNotifications = "$baseUrl/notifications/get";
  static String createNotifications = "$baseUrl/notifications/create";
}
